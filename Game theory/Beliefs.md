A belief of player $i$ is a possible profile of oppnents' strategies: an element of set $\Delta S_{-i}$ (**which is the same definition of pure strategy but with $\Delta$**)
